...
namespace Ogre {
	...
	protected:
		...
		/******************************** public methods ******************************/
	public:
		MovableText(const String &name, const UTFString &caption, const String &fontName = "BlueHighway-8", Real charHeight = 1.0, const ColourValue &color = ColourValue::White);
		virtual ~MovableText();
